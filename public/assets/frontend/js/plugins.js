    ...
    (e.prototype.init = function () {
        ...
        (e.prototype.isVideo = function (a, b) {
            ...
            var d = a.match(/\/\/(?:www\.)?youtu(?:\.be|be\.com)\/(?:watch\?v=|embed\/)?([a-z0-9\-\_\%]+)/i),
                ...
                f = a.match(/\/\/(?:www\.)?energychronicles.local\/([0-9a-z\-_]+)/i),
        ...
        (s.prototype.loadVideo = function (o, i, l, a, s) {
            ...
            if ((l && (t = this.videoLoaded ? 0 : 1), c.youtube))
                ...
                (d = "?wmode=opaque&autoplay=" + t + "&api=postMessage"),
                    ...
                    (r = '<video controls autoplay width="100%" controlsList="nodownload"><source src="'+c.dailymotion.input+'" type="video/mp4"></video>');
            else if (c.html5) {
