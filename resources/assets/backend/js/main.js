...
(function () {
  ...
  function switchImage(style) {
    ...
    switchImagesList.map(function (imageEl) {
      ...
      imageEl.src = assetsPath + 'backend/img/' + setImage; // Using window.assetsPath to get the exact relative path
    });
  }
...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      var searchData = $.ajax({
        url: assetsPath + 'backend/json/' + searchJson, //? Use your own search api instead
        dataType: 'json',
        async: false
      }).responseJSON;
