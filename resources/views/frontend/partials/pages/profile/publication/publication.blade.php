                        ...
                        <div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="profile-edit-container fl-wrap block_box">
                                            <div class="custom-form">
                                                <form action="{{route('profile.publication.store')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label>Title <i class="fal fa-bookmark"></i><span class="text-danger">*</span></label>
                                                            <input type="text" name="title" placeholder="Title" value=" {{old('title')}}" required/>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label>Link <i class="fal fa-link"></i> <span class="text-danger">*</span></label>
                                                            <input type="text" name="link" placeholder="Link" value=" {{old('link')}}" required/>
                                                        </div>


                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn big-btn color-bg flat-btn"> Add Publication <i class="fal fa-paper-plane"></i></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                            ...
                            <div class="grid-post-wrap" style="margin-top: 20px">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="profile-edit-container fl-wrap block_box">
                                            <table class="table" width="100%" id="publicationTable">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    @foreach ($data['rose']['publications'] as $publication)
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center; margin-left:10px">{{$publication->link}}</td>
                                                            <td style="text-align: center; margin-left:10px">
                                                                <form action="{{ route('profile.publication.delete', $publication->hashId) }}" method="POST" class="d-inline-block">
                                                                    @csrf
                                            ...
                                            <!--pagination-->
                                            {!! $data['rose']['publications']->links('vendor.pagination.profile-page-news') !!}
                                            <!--pagination end-->
                                        </div>
                                    </div>
                                </div>
