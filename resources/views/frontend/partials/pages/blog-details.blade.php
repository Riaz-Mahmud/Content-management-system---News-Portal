                    ...
                    <div class="breadcrumbs-header fl-wrap">
                        <div class="container">
                            <div class="breadcrumbs-header_url">
                                <a href="{{route('home')}}">Home</a><span>Blog Details</span>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="main-container fl-wrap fix-container-init">
                                        ...
                                        <div class="single-post-header fl-wrap">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="author-link"><a href="{{route('profile')}}"><img src="{{asset('assets/frontend/images/all/1.jpg')}}" alt="">  <span>By Mark Rose</span></a></div>
                                        ...
                                        <div class="post-author fl-wrap">
                                            <div class="author-img">
                                                <img  src=" {{asset('assets/frontend/images/avatar/1.png')}} " alt="">	
                                            </div>
                                            ...
                                            <div class="list-post-wrap list-post-wrap_column fl-wrap">
                                                <div class="row">
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            ...
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg" data-bg=" {{asset('assets/frontend/images/all/bestcat/1.png')}}"></div>
                                                                    </div>
                                                                </a>
                                                    ...
                                                    <div class="col-md-6">
                                                        <!--list-post-->	
                                                        <div class="list-post fl-wrap">
                                                            <a class="post-category-marker" href="category.html">Renewable Energy</a>
                                                            <div class="list-post-media">
                                                                <a href="{{route('news-details')}}">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg" data-bg="{{asset('assets/frontend/images/all/bestcat/2.png')}}"></div>
                                                                    </div>
                                                                </a>
                                                                <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                            </div>
                                                            <div class="list-post-content">
                                                                <h3><a href="{{route('news-details')}}">Warriors face season defining clash</a></h3>
                                            ...
                                            <ul class="commentlist clearafix">
                                                <li class="comment">
                                                    <div class="comment-author">
                                                        <img alt="" src=" {{asset('assets/frontend/images/avatar/3.png')}}" width="50" height="50">
                                                    </div>
                                                ...
                                                <li class="comment comment_reply">
                                                    <div class="comment-author">
                                                        <img alt="" src=" {{asset('assets/frontend/images/avatar/1.png')}}" width="50" height="50">
                                                    </div>
                                                    <div class="comment-body smpar">
                                                ...
                                                <li class="comment">
                                                    <div class="comment-author">
                                                        <img alt="" src=" {{asset('assets/frontend/images/avatar/203.png')}}" width="50" height="50">
                                                    </div>
                                                    <div class="comment-body smpar">
                                                        <h4><a href="#">Liza Rose</a></h4>
                                                        <div class="box-widget-menu-btn smact"><i class="far fa-ellipsis-h"></i></div>
                                            ...
                                            <div class="box-widget-content">
                                                <div class="banner-widget fl-wrap">
                                                    <div class="bg-wrap bg-parallax-wrap-gradien">
                                                        <div class="bg  " data-bg="images/all/topstories/4.jpg"></div>
                                                    </div>
