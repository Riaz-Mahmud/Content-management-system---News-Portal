...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- Quick links  -->
        <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 me-xl-0" style="display: none;">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
        ...
        <!-- Notification -->
        <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1" style="display: none;">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                data-bs-auto-close="outside" aria-expanded="false">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar">
                                        <img src="{{ asset('assets/backend/img/avatars/9.png') }}" alt
                                            class="w-px-40 h-auto rounded-circle">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar">
                                        <img src="{{ asset('assets/backend/img/avatars/5.png') }}" alt
                                            class="w-px-40 h-auto rounded-circle">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar">
                                        <img src="{{ asset('assets/backend/img/avatars/6.png') }}" alt
                                            class="w-px-40 h-auto rounded-circle">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
        ...
        @if (Auth::user()->hasRole('Super Admin'))
            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                ...
                <ul class="dropdown-menu dropdown-menu-end py-0">
                    <li class="dropdown-menu-header border-bottom">
                        <div class="dropdown-header d-flex align-items-center py-3">
                            <h5 class="text-body mb-0 me-auto">System Control</h5>
                        </div>
                    </li>
                    <li class="dropdown-notifications-list scrollable-container">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <a onclick="return confirm('Are you sure?')"
                                        href="{{ route('admin.system.clear-cache') }}" class="flex-shrink-0 me-3">
                                        <span><i class="bx bx-link"></i> Clear Cache</span>
                                    </a>
                                </div>
                            </li>
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <a onclick="return confirm('Are you sure?')"
                                        href="{{ route('admin.system.storage-link') }}" class="flex-shrink-0 me-3">
                                        <span><i class="bx bx-link"></i> Generate Storate Link</span>
                                    </a>
                                </div>
                            </li>
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <a onclick="return confirm('Are you sure?')"
                                        href="{{ route('admin.system.migrate') }}" class="flex-shrink-0 me-3">
                                        <span><i class="bx bx-link"></i> Migrate</span>
                                    </a>
                                </div>
                            </li>
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <a onclick="return confirm('Are you sure?')"
                                        href="{{ route('admin.system.migrate-fresh') }}" class="flex-shrink-0 me-3">
                                        <span><i class="bx bx-link"></i> Migrate Fresh</span>
                                    </a>
                                </div>
                            </li>
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <a onclick="return confirm('Are you sure?')"
                                        href="{{ route('admin.system.key-generate') }}" class="flex-shrink-0 me-3">
                                        <span><i class="bx bx-link"></i> Key Generate</span>
                                    </a>
                                </div>
                            </li>
                        </ul>
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('admin.profile.security', Auth::user()->email) }}">
