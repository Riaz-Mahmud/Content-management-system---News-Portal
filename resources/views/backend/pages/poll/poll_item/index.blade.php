...
@section('content')
    ...
    <div class="row g-8 mb-4">
        <div class="card-tools">
            <a href="{{route('admin.poll.item.create', Crypt::encrypt($data['poll']->id)) }}" class="btn btn-primary btn-sm">
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title">Poll Item List</h5>
                ...
                <tbody>
                    @foreach ($data['rose'] as $key => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.poll.item.edit', Crypt::encrypt($item->id)) }}" class="btn btn-sm btn-primary mb-1 mt-1" title="Edit">
                                    <i class="fa fa-edit text-white"></i>
                                </a>
                                <form action="{{ route('admin.poll.item.delete', Crypt::encrypt($item->id)) }}" method="POST" class="d-inline-block">
                                    @csrf
