        ...
        <div class="" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            <div class="card-header border-bottom">
                <div class="offcanvas-header">
                    <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Add New Tags</h5>
                </div>
                <div class="offcanvas-body mx-0 flex-grow-0">
                    <form class="add-new-user pt-0" id="addNewUserForm" action="{{route('admin.tags.store')}}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label" for="add-tags-label">Lable</label>
                            <input type="text" class="form-control" id="add-tags-label" name="label" placeholder="Enter label" value="{{old('label')}}" required />
                        </div>
                        <div class="mb-4">
