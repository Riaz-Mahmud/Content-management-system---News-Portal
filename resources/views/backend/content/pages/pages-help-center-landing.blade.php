        ...
        <div class="col-lg-10 mx-auto">
          <div class="row mb-3">
            <div class="col-md-4 mb-md-0 mb-4">
              <div class="card border shadow-none">
                <div class="card-body text-center">
                  <img class="mb-3" src="{{asset('assets/img/icons/unicons/rocket.png')}}" height="60" alt="Help center articles">
            ...
            <div class="col-md-4 mb-md-0 mb-4">
              <div class="card border shadow-none">
                <div class="card-body text-center">
                  <img class="mb-3" src="{{asset('assets/img/icons/unicons/cube-secondary.png')}}" height="60" alt="Help center articles">
                  <h5>First Steps</h5>
            ...
            <div class="col-md-4">
              <div class="card border shadow-none">
                <div class="card-body text-center">
                  <img class="mb-3" src="{{asset('assets/img/icons/unicons/desktop.png')}}" height="60" alt="Help center articles">
      ...
      <div class="row justify-content-center py-5 my-3">
        <div class="col-md-8 col-lg-6 text-center">
          ...
          <p class="mb-4"> Our specialists are always happy to help. Contact <br>
            ...
            <br> and we'll get back to you. </p>
