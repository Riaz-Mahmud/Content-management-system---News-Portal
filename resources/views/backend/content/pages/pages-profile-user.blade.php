...
<link rel="stylesheet" href="{{asset('assets/backend/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css')}}">
@endsection
...
@section('page-script')
<script src="{{asset('assets/backend/js/pages-profile.js')}}"></script>
@endsection
        ...
        <ul class="timeline ms-2">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex flex-wrap">
                <div class="avatar me-3">
                  <img src="{{asset('assets/backend/img/avatars/3.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div>
          ...
          <li class="timeline-item timeline-item-transparent">
            ...
            <div class="timeline-event">
              ...
              <p class="mb-2">Sent by Mollie Dixon <img src="{{asset('assets/backend/img/avatars/4.png')}}" class="rounded-circle ms-3" alt="avatar" height="20" width="20"></p>
              <div class="d-flex flex-wrap gap-2">
                <a href="javascript:void(0)" class="me-3">
                  <img src="{{asset('assets/backend/img/icons/misc/pdf.png')}}" alt="Document image" width="20" class="me-2">
                  <span class="h6">App Guidelines</span>
                </a>
                <a href="javascript:void(0)">
                  <img src="{{asset('assets/backend/img/icons/misc/xls.png')}}" alt="Excel image" width="20" class="me-2">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-3">
                <div class="d-flex align-items-start">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="{{asset('assets/backend/img/avatars/2.png')}}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-start">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="{{asset('assets/backend/img/avatars/10.png')}}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-start">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="{{asset('assets/backend/img/avatars/7.png')}}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-start">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="{{asset('assets/backend/img/avatars/12.png')}}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="{{asset('assets/backend/img/icons/brands/twitter-label.png')}}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-w">
