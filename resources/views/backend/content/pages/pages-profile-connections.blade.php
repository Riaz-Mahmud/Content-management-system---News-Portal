    ...
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="mx-auto mb-3">
          <img src="{{asset('assets/backend/img/avatars/3.png')}}" alt="Avatar Image" class="rounded-circle w-px-100" />
        </div>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="mx-auto mb-3">
          <img src="{{asset('assets/backend/img/avatars/12.png')}}" alt="Avatar Image" class="rounded-circle w-px-100" />
        </div>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="mx-auto mb-3">
          <img src="{{asset('assets/backend/img/avatars/5.png')}}" alt="Avatar Image" class="rounded-circle w-px-100" />
        </div>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="mx-auto mb-3">
          <img src="{{asset('assets/backend/img/avatars/18.png')}}" alt="Avatar Image" class="rounded-circle w-px-100" />
        </div>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="mx-auto mb-3">
          <img src="{{asset('assets/backend/img/avatars/9.png')}}" alt="Avatar Image" class="rounded-circle w-px-100" />
        </div>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="mx-auto mb-3">
          <img src="{{asset('assets/backend/img/avatars/10.png')}}" alt="Avatar Image" class="rounded-circle w-px-100" />
        </div>
