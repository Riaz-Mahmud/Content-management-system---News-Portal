    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="paymentDataList" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded"></i>
                        </button>
                ...
                <div class="card-body">
                    ...
                    <form id="paymentMethodForm" class="row g-3" onsubmit="return false">
                                    ...
                                    <div class="form-check custom-option custom-option-basic">
                                        <label class="form-check-label custom-option-content py-2"
                                            ...
                                            <input name="customRadioTemp" class="form-check-input" type="radio"
                                                value="" id="customRadioPaypal" checked />
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group input-group-merge">
                                <input id="paymentAddCard" name="paymentAddCard" class="form-control credit-card-payment"
                                    ...
                                    aria-describedby="paymentAddCard2" />
                                <span class="input-group-text cursor-pointer p-1" id="paymentAddCard2"><span
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="paymentAddCardCvv" class="form-control cvv-code-payment"
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="purchaseItemList" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded"></i>
                        </button>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <p class="mb-4">Please make the payment to start enjoying all the features of our premium plan as
                        soon as possible.</p>
                    <div class="d-flex border-primary p-2 border rounded mb-4">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('assets/img/icons/unicons/briefcase.png') }}" alt="User"
                                class="rounded">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <form id="paymentDetailsForm" onsubmit="return false" class="pt-2">
                        ...
                        <div class="d-flex mb-4">
                            <div class="me-3">
                                <img src="{{ asset('assets/img/icons/payments/visa-' . $configData['style'] . '.png') }}"
                                    alt="Visa" height="30" data-app-light-img="icons/payments/visa-light.png"
                            ...
                            <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                ...
                                <div class="w-px-75">
                                    <input type="text" class="form-control cvv-code-payment" maxlength="3"
                                        placeholder="CVV" />
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="me-3">
                                <img src="{{ asset('assets/img/icons/payments/master-' . $configData['style'] . '.png') }}"
                                    alt="MasterCard" height="30" data-app-light-img="icons/payments/master-light.png"
                        ...
                        <a href="javascript:;" class="fw-semibold d-block my-2" data-bs-toggle="modal"
                            ...
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <small class="fw-semibold">$1,619</small><i
                                        class='bx bx-chevron-up text-success ms-1'></i> <small
                                        class="text-muted">18.6%</small>
                                </div>
                            </div>
                        </li>
                        <li class="d-flex mb-4 pb-1">
                                    ...
                                    <div class="d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-0 text-truncate">Nathan Wagner</h6><small
                                                class="text-truncate text-muted">iOS Developer</small>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-0 text-truncate">Emma Bowen</h6><small
                                                class="text-truncate text-muted">UI/UX Designer</small>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-0 text-truncate">Adrian McGuire</h6><small
                                                class="text-truncate text-muted">PHP Developer</small>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-0 text-truncate">Alma Gonzalez</h6><small
                                                class="text-truncate text-muted">Product Manager</small>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/chrome.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/safari.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/firefox.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/edge.png') }}" alt="Edge"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/opera.png') }}"
                                            ...
                                            <div class="d-flex justify-content-between align-items-center gap-3">
                                                <div class="progress w-100" style="height:10px;">
                                                    <div class="progress-bar bg-danger" role="progressbar"
                                                        style="width: 1.94%" aria-valuenow="1.94" aria-valuemin="0"
                                                        aria-valuemax="100"></div>
                                                </div>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/windows.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/mac.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/ubuntu.png') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/brands/cent.png') }}"
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/svg/flags/us.svg') }}" alt="USA"
                                                    height="24" class="me-2">
                                                <span>USA</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/svg/flags/br.svg') }}" alt="Brazil"
                                                    height="24" class="me-2">
                                                <span>Brazil</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/svg/flags/in.svg') }}" alt="India"
                                                    height="24" class="me-2">
                                                <span>India</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/svg/flags/au.svg') }}" alt="Australia"
                                                    height="24" class="me-2">
                                                <span>Australia</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/svg/flags/fr.svg') }}" alt="France"
                                                    height="24" class="me-2">
                                                <span>France</span>
                                            </div>
                                        </td>
                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-4">
                            <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <i class='bx bx-up-arrow-alt text-success me-2'></i> <small
                                        class="fw-smibold">12.8%</small>
                                </div>
                            </div>
                        </li>
                        <li class="d-flex mb-4">
                            <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <i class='bx bx-down-arrow-alt text-danger me-2'></i> <small class="fw-semibold">-
                                        8.5% </small>
                                </div>
                            </div>
                        </li>
