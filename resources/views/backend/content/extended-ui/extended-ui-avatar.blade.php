      ...
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap">
          <div class="avatar avatar-xs me-2">
            <img src="{{asset('assets/backend/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle">
          </div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="d-flex align-items-center my-3">
          ...
          <div class="avatar me-2">
            <img src="{{asset('assets/backend/img/avatars/1.png')}}" alt="Avatar" class="rounded">
          </div>
          <div class="avatar">
            <img src="{{asset('assets/backend/img/avatars/1.png')}}" alt="Avatar">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="avatar me-2 avatar-online">
            <img src="{{asset('assets/backend/img/avatars/8.png')}}" alt="Avatar" class="rounded-circle">
          </div>
          <div class="avatar me-2 avatar-away">
            <img src="{{asset('assets/backend/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle">
          </div>
          <div class="avatar me-2 avatar-busy">
            <img src="{{asset('assets/backend/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle">
          </div>
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        ...
        <div class="d-flex align-items-center avatar-group my-3">
          ...
          <div class="avatar">
            <img src="{{asset('assets/backend/img/avatars/6.png')}}" alt="Avatar" class="rounded-circle">
          </div>
          <div class="avatar">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="d-flex align-items-center avatar-group my-3">
          <div class="avatar">
            <img src="{{asset('assets/backend/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle pull-up">
          </div>
          <div class="avatar">
            <img src="{{asset('assets/backend/img/avatars/12.png')}}" alt="Avatar" class="rounded-circle pull-up">
          </div>
          <div class="avatar">
            <img src="{{asset('assets/backend/img/avatars/6.png')}}" alt="Avatar" class="rounded-circle pull-up">
          </div>
          <div class="avatar">
            <img src="{{asset('assets/backend/img/avatars/10.png')}}" alt="Avatar" class="rounded-circle pull-up">
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
