...
class SingleNewsWithLeftSideSlide extends Component
{
        ...
        if(count($code) > 0){
            foreach($code as $item){
                $this->data['items'][] = [
                    ...
                    'author_image' => ImageHelper::generateImage($item->user->profile->image),
                ];
            }
        }
    }
    ...
    public function render(){
        return view('components.frontend.slide.single-news-with-left-side-slide')->with('data', $this->data);
    }
}
