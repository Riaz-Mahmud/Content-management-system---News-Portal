...
class RoleController extends BackendController
{
    public function __construct(){
        ...
        $this->middleware('permission:admin.role.create')->only(['store']);
        $this->middleware('permission:admin.role.edit')->only(['update']);
    ...
    function index(Request $request){
        ...
        foreach($data['roles'] as $role){
            ...
            foreach($role->users as $user){
                ...
                $user->image = ImageHelper::generateImage($user->profile->image, 'thumbnail');
            }
